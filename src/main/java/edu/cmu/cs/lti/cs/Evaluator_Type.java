...
/* First created by JCasGen Tue Sep 10 21:11:55 EDT 2013 */
package edu.cmu.cs.lti.cs;
...
public class Evaluator_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.lti.cs.Evaluator");
  ...
  public int getPredictedScoreArray(int addr) {
      ...
      jcas.throwFeatMissing("PredictedScoreArray", "edu.cmu.cs.lti.cs.Evaluator");
  ...
  public int getGroundTruthScoreArray(int addr) {
      ...
      jcas.throwFeatMissing("GroundTruthScoreArray", "edu.cmu.cs.lti.cs.Evaluator");
